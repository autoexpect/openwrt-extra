-- Copyright (C) 2016-2021 张瑞 <rui.crater@gmail.com>
...
o:value("/etc/chnroute.txt", "/etc/chnroute.txt")
...
o:value("/dev/null", "None")
o:value("/etc/fw_ip_list.txt", "/etc/fw_ip_list.txt")
o.datatype = "or(file, '/dev/null')"
o.default = "/etc/fw_ip_list.txt"
o.rmempty = true
